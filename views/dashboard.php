    ...
    <?php foreach($data as $datas=>$city) : ?>
        ...
        <div class="flex flex-col border-1 rounded-lg  w-9/10 md:w-auto mt-9 md:mr-4">
            <div class="flex flex-col md:flex-row justify-around mt-3 h-fit">
                <p class="text-2xl font-bold ml-3 md:ml-0"><?=$city['name']?></p>
                <?php if (isset($city['air'])) : ?>
                    <?php if ($city['air']['european_aqi'] <= 50): ?>
                        <p class="border-1 rounded-lg bg-[#69A33D] text-xl w-fit md:w-auto h-fit p-1 ml-2 md:ml-0">IQA : <?=$city['air']['european_aqi']?> (Bon)</p>
                    <?php elseif ($city['air']['european_aqi'] <= 100): ?>
                        <p class="border-1 rounded-lg bg-[#E9D92C] text-xl w-fit md:w-auto h-fit p-1 ml-2 md:ml-0">IQA : <?=$city['air']['european_aqi']?> (Modéré)</p>
                    <?php elseif ($city['air']['european_aqi'] <= 150): ?>
                        <p class="border-1 rounded-lg bg-[#EA6C29] text-xl w-fit md:w-auto h-fit p-1 ml-2 md:ml-0">IQA : <?=$city['air']['european_aqi']?> (Pas bon)</p>
                    <?php elseif ($city['air']['european_aqi'] <= 200): ?>
                        <p class="border-1 rounded-lg bg-[#F01F1F] text-xl w-fit md:w-auto h-fit p-1 ml-2 md:ml-0">IQA : <?=$city['air']['european_aqi']?> (Mauvais)</p>
                    <?php elseif ($city['air']['european_aqi'] <= 300): ?>
                        <p class="border-1 rounded-lg bg-[#AA24CC] text-xl w-fit md:w-auto h-fit p-1 ml-2 md:ml-0">IQA : <?=$city['air']['european_aqi']?> (Très mauvais)</p>
                    <?php endif;?>
                <?php else : ?>
            ...
            <div class="flex flex-col md:grid md:grid-cols-2">
                    ...
                    <div class="flex flex-col items-center m-3">
                        ...
                        <?php if (isset($city['air'])) : ?>
                            <?php if ($city['air']['pm2_5'] <= 10) : ?>
                                <div class="flex flex-col items-center justify-center bg-[#69A33D] size-25 md:size-20 rounded-full">
                            <?php elseif ($city['air']['pm2_5'] <= 25) : ?>
                                <div class="flex flex-col items-center justify-center bg-[#E9D92C] size-25 md:size-20 rounded-full">
                            <?php elseif ($city['air']['pm2_5'] <= 50) : ?> 
                                <div class="flex flex-col items-center justify-center bg-[#EA6C29] size-25 md:size-20 rounded-full">
                            <?php elseif ($city['air']['pm2_5'] <= 75) : ?> 
                                <div class="flex flex-col items-center justify-center bg-[#F01F1F] size-25 md:size-20 rounded-full">
                            <?php elseif ($city['air']['pm2_5'] > 75) : ?> 
                                <div class="flex flex-col items-center justify-center bg-[#AA24CC] size-25 md:size-20 rounded-full">
                            <?php endif ?>
                                <p class="text-lg"><?=$city['air']['pm2_5']?></p>
                                <p class="text-lg">µg/m3</p>
                        <?php else: ?>
                            <div class="">
                                <p>Donnée non <br> disponible</p>
                        <?php endif;?>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col items-center m-3">
                        ...
                        <?php if (isset($city['air'])) : ?>
                            ...
                            <?php elseif ($city['air']['pm10'] > 200) : ?> 
                                <div class="flex flex-col items-center justify-center bg-[#AA24CC] size-25 md:size-20 rounded-full">
                            <?php endif ?>
                                <p class="text-lg"><?=$city['air']['pm10']?></p>
                                <p class="text-lg">µg/m3</p>
                        <?php else: ?>
                            <div class="">
                            <p>Donnée non <br> disponible</p>
                    ...
                    <div class="flex flex-col items-center m-3">
                        ...
                        <?php if (isset($city['air'])) : ?>
                            ...
                            <?php elseif ($city['air']['nitrogen_dioxide'] > 200) : ?> 
                                <div class="flex flex-col items-center justify-center bg-[#AA24CC] size-25 md:size-20 rounded-full">
                            <?php endif ?>
                                <p class="text-lg"><?=$city['air']['nitrogen_dioxide']?></p>
                                <p class="text-lg">µg/m3</p>
                        <?php else: ?>
                            <div class="">
                            <p>Donnée non <br> disponible</p>
                    ...
                    <div class="flex flex-col items-center m-3">
                        ...
                        <?php if (isset($city['air'])) : ?>
                            ...
                            <?php elseif ($city['air']['ozone'] > 180) : ?> 
                                <div class="flex flex-col items-center justify-center bg-[#AA24CC] size-25 md:size-20 rounded-full">
                            <?php endif ?>
                                <p class="text-lg"><?=$city['air']['ozone']?></p>
                                <p class="text-lg">µg/m3</p>
                        <?php else: ?>
                            <div class="">
                            <p>Donnée non <br> disponible</p>
                ...
                <div class="grid grid-rows-2 grid-cols-3 md:grid-rows-3 md:grid-cols-2 md:h-fit md:gap-4 md:self-center mt-3 md:mt-0">
                    ...
                    <?php if (isset($city['weather'])) : ?>
                        <p class="col-1 row-2 md:col-auto md:row-auto justify-self-center md:justify-self-start text-lg h-fit"><?=$city['weather']['temperature_2m']?> °C</p>
                    <?php else :?>
                        <p class="col-1 row-2 md:col-auto md:row-auto justify-self-center md:justify-self-start text-lg h-fit">Indisponible</p>
                    <?php endif;?>
